...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "3034aab8d80698b88e17cc702331a922";
    ...
    protected void onResume() {
        ...
        if(city != null){
            Log.d("Clima", "City name from Intent: " + city);
    ...
    public void getWeatherForCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onProviderDisabled(String s) {
                Log.d("Clima", "onLocationDisabled() callback received");
            }
        };
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.LOCATION_HARDWARE}, REQUEST_CODE);
            return;
        }
